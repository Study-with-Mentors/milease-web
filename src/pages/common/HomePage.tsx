            ...
            <div className={styled["container-detail"]}>
                ...
                <div>
                    <div className={styled["detail-flex-multiple"]}>
                        ...
                        <WhatWeDoCard image={WhatWeDoImage2} title="Corporate" description="At Locale Travel, our job is to guide you through this fast-paced environment, ensuring your travel program is running smoothly and efficiently while your travellers receive the best in customer service, technology and security." />
                        <WhatWeDoCard image={WhatWeDoImage3} title="Schedule Arrangement" description="You can be confident your leisure and holiday travel will be a unique and well crafted 'event' - because Locale Travel will apply the quality and personal attention and experience we apply to all our travel solutions." />
                        <WhatWeDoCard image={WhatWeDoImage4} title="Expense Support" description="Highly experienced staff that understand the flexibility and organisation that’s needed. Over three decades of experience with touring parties. Close relationships with the travel suppliers you use. Exceptional service and benefits when you need it now. Not later." />
                        <WhatWeDoCard image={WhatWeDoImage5} title="Smart Route options" description="Your successful group travel and conference is created from a mix of the right people, resources and know-how. Take advantage of our unique group travel & conference technology tools." />
                    </div>
                </div>
                <div className={styled["detail-flex-center"]}>
